...
const about = {
  ...
  intro: {
    ...
    description: (
      <>
        A Full Stack Developer with a passion for transforming complex challenges
  ...
  technical: {
    ...
    skills: [
      {
        title: "Django",
        description: <>Able to build modules with unnatural speed.</>,
        images: [
          {
      ...
      {
        title: "Next.js",
        description: <>Building next gen apps with Next.js + shadcn + Supabase + Neon</>,
        // optional: leave the array empty if you don't want to display images
        images: [
          {
            src: "/images/projects/project-01/cover-04.png",
            alt: "Ashboard Project Image",
            width: 16,
            height: 9,
          },
        ],
